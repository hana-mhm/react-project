...
import { Style } from "../HeroMovie/style";
    ...
    return(
        <Style>
            <div className="hero-movie">
               ...
               style={{backgroundImage:"url(https://us-thumbnail.s3-us-west-1.amazonaws.com/1/7/mm/p6izb_tnl_1920x1080.jpg?ts=20231122192623)"}}
              ...
              <div className="container">
                  <h1 className="name">{title}</h1>
                    <div className="flex gap-10 align-center">
                        ...
                        <Button icon="fa-solid fa-play" type="primary">watchnow</Button>
                            <Button  type="dark">more info</Button>
                        </div>
                        </div>
